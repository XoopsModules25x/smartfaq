...
/**
* $Id: main.php,v 1.21 2005/08/15 16:51:57 fx2024 Exp $
* Module: SmartFAQ
...
//$pick = isset($_POST['pick'])? intval($_POST['pick']) : $_GET['pick'];

$statussel = isset($_GET['statussel'])? intval($_GET['statussel']) : _SF_STATUS_ALL;
...
//echo "<img onclick='toggle('toptable'); toggleIcon('toptableicon');' id='toptableicon' name='toptableicon' src=" . XOOPS_URL . "/modules/" . $xoopsModule->dirname() . "/images/icon/close12.gif alt='' /></a>&nbsp;" . _AM_SF_INVENTORY . "</h3>";
...
echo "<img id='bottomtableicon' src=" . XOOPS_URL . "/modules/" . $xoopsModule->dirname() . "/images/icon/close12.gif alt='' /></a>&nbsp;" . _AM_SF_ALLFAQS . "</h3>";
...
//mb---------------------------------------
        ...
        $answerObjects = $answer_handler->getObjects($criteria, true);
