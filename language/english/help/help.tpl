<div id="help-template" class="outer">
    ...
    <p class="even">Tutorial is available on <a href="https://xoops.gitbook.io/smartfaq-tutorial"
                                                target="_blank">GitBook</a>

    <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/smartfaq-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModules25x/smartfaq" target="_blank">GitHub</a><br><br>
